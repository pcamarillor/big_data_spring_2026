...
from pyspark.sql.types import (
    ...
    DoubleType, FloatType, BooleanType, DateType, TimestampType, BinaryType, ArrayType
)
from pyspark.sql.functions import when, count, isnull, col, avg
