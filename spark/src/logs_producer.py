...
Usage examples:
  ...
  python3 /opt/spark/work-dir/src/logs_producer.py local --location /opt/spark/work-dir/data/streaming/logs/ --files 3 --lines 50

  # Cloud mode — upload to S3 (run on EC2)
  python3 logs_producer.py cloud --bucket iteso-bucket-1 --prefix logs/input --files 3 --lines 50
...
#        time.sleep(15) # ------------------BORRAR-------------------------------------------------------ASasFSDFASDFASDKFJHGASDKFJshgkjHADSGFKASJDHGFAKSDJHFGAK
